...
#Substituir pelo que será instalado link: https://github.com/amberblade/warp-ctc/
...
f = open('OctShuffle-MLT-master/codec.txt', 'r')
codec = f.readlines()[0]
codec_rev = {}
index = 4
...
if __name__ == '__main__': 
  ...
  parser.add_argument('-save_path', default='OctShuffle-MLT-master/backup')
